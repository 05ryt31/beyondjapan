...
function load_blog_posts() {
    $offset = isset($_POST['post_num_now']) ? intval($_POST['post_num_now']) : 1;
    $posts_per_page = isset($_POST['post_num_add']) ? intval($_POST['post_num_add']) : 3;
